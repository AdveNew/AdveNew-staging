...
export default function CustomerTrips() {
  ...
  const [rows, setRows] = useState([{
    id: 1, guide: 'error', experience: 'error', location: 'error', startDate: new Date(),
  }]);
  ...
  const columns = [
    {
      field: 'startDate', headerName: 'Date', flex: 0.8, renderCell: (d) => format(parseISO(d.value), 'EEE MMM-dd'),
    },
    ...
    return (
      <GridOverlay className={classes.root}>
        ...
        <div className={classes.label}>
          You haven&lsquo;t booked any trips yet, better now than never!
        </div>
      </GridOverlay>
    );
  }
